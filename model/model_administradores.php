<?php
	...
	class model_administradores {
		...
		public function loginAdministrador($codigo, $password) {
			$sql = " SELECT NIT, NOMBRE FROM administrador WHERE NIT = '$codigo' AND PASSWORD = '$password' ";
