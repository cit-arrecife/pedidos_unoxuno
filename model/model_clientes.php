<?php
	...
	class model_clientes {
		...
		public function loginCliente($codigo, $password) {
			$sql = " SELECT NIT, NOMBRE, APELLIDO1, DIRECCION, EMAIL, VENDEDOR FROM mtprocli WHERE NIT = '$codigo' AND PASSWORD = '$password' ";
