            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div class="col-sm-4" style="text-align:right;">
                            <label style="color:#000;">Total Cliente</label>
                        </div>

                        <div class="col-sm-4">
                            <label style="color:#000;">SubTotal</label>
                        </div>
                        ...
                        <div class="col-sm-4" style="text-align:right;">
                            ...
                            <label style="color:#000;">$ <label><label style="color:#000;" id="ro_subtotal_distribuidor">0.00</label>
                        </div>
                        ...
                        <div class="col-sm-4" style="text-align:right;">
                             <label style="color:#000;">$ <label><label style="color:#000;" id="ro_iva_distribuidor">0.00</label>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <label style="color:#000;">Total Pedido</label>
                        </div>
                        ...
                        <div class="col-sm-4" style="text-align:right;">
                              ...
                              <label style="color:#000;">$ <label><label style="color:#000;" id="ro_total_distribuidor">0.00</label>
                        </div>
