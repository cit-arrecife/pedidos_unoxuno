  ...
  <head>
    ...
    <script>
		$(document).ready(function(){
			...
			consultarCotizacion(<?php echo $_REQUEST['codigo']; ?>);
  ...
  <body style="">
    <div class="container">
		...
		<div class="form-group col-sm-3">
    		...
    		<input id="grupo_venta" class="form-control" type="hidden" value="">
    		<button class="btn btn-success" type="button" title="Guardar Modificaciones" onclick="guardarModificaciones()"><span class="glyphicon glyphicon-floppy-disk"></span>Guardar Modificaciones</button>
		</div>
